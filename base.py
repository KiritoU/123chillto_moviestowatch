...
class Crawler:
    ...
    def crawl_film(
        ...
        bwac_btn = soup.find("a", class_="bwac-btn")
        play_href = bwac_btn.get("href")
    ...
    def crawl_ml_item(
        ...
        try:
            ...
            if not href.startswith("https://"):
                href = CONFIG.CHILLTO123_HOMEPAGE + href
...
if __name__ == "__main__":
    Crawler().crawl_page(url=CONFIG.CHILLTO123_TVSHOWS_PAGE + "/page/2/")
    Crawler().crawl_page(
        url=CONFIG.CHILLTO123_MOVIES_PAGE + "/page/1/", post_type=CONFIG.TYPE_MOVIE
    )
